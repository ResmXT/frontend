...
const Resume = ({ user, changeBG, changeTab }) => {
  ...
  return (
    <div className="w-[75vw]  px-24 rounded-lg my-[18px] pt-5  bg-[#15171a]">
        ...
        <div className="w-full aspect-[2/3] bg-white mb-10 px-16 py-16">
          <div className="">
            ...
            <div className="flex justify-between mt-3">
              ...
              <div className="">
                {user?.basic_info?.state} , {user?.basic_info?.city}
              </div>
            </div>
            <div className="flex justify-between mt-3">
          ...
          <div className="">
            ...
            <div className="mt-2 mb-2">{user?.basic_info?.about}</div>
          </div>
          <div className="">
          ...
          <div className="">
            <div className="text-[25px] mt-5 mb-2 font-medium">
              Work Experience
            </div>
            <div className="w-full h-1 bg-black"></div>
            {user?.work_experience.map(e => (
              <div className="" key={e}>
                ...
                <div className="">
                  ...
                  ullam consectetur, expedita quia, repellat perspiciatis rerum
                  quasi ab facilis animi omnis doloremque nesciunt?
                </div>
              </div>
            ))}
          </div>
            ...
            {user?.projects.map(e => (
              <div className="" key={e}>
                ...
                <div className="">
                  ...
                  Recusandae minus voluptatibus ratione tempore molestiae illum
                  esse repudiandae eius atque, praesentium fuga dolorum nostrum
                  suscipit incidunt laudantium quaerat necessitatibus,
          ...
          <div className="">
            ...
            <div className="flex flex-wrap mt-5">
              {user?.skills.map(e => (
                <div
                  key={e}
                  className="px-5 py-2 bg-slate-300 rounded-full mr-3 mb-3"
                >
                  {e}
                </div>
              ))}
