...
const Education = ({user,changeTab,changeBG}) => {
  const [institute_name,setInstitute]=useState(user?.education[0]?.institute_name);
...
//     onPostEducation([{institute_name,state,field,degree,cgpa,start_year}],onChangeTab)
//   }
  return (
    <div>
